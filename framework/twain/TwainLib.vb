...
Namespace TwainLib
    ...
    Public Class Twain
        ...
        End Function
        <DllImport("kernel32.dll", ExactSpelling:=True)> Shared Function GlobalLock(ByVal handle As IntPtr) As IntPtr
        End Function
        ...
        Public Sub Acquire()
            ...
            If Equals(appid.Id, IntPtr.Zero) = True Then
                Init(hwnd)
                If Equals(appid.Id, IntPtr.Zero) = True Then Return
            End If

            rc = DSMident(appid, IntPtr.Zero, TwDG.Control, TwDAT.Identity, TwMSG.OpenDS, srcds)
            If (rc <> TwRC.Success) Then Return
